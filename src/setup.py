...
REQUIRES_PYTHON = '>=3.9'
VERSION = '0.0.1'
GEMFURY = f'twine upload dist/* --repository-url https://push.fury.io/musicfox -u {os.environ.get("TWINE_TOKEN")} -p ""' 
...
setup(
    ...
    #py_modules=['mfcrypt'],
    packages=find_packages(exclude=["tests", "*.tests", "*.tests.*", "tests.*", "node_modules"]),
    # entry_points={
